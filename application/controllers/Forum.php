...
class Forum extends CI_Controller {
	...
	public function create_forum() {
		...
		$this->form_validation->set_rules('title', 'Forum Title', 'trim|required|min_length[0]|max_length[255]|is_unique[forums.title]', array('is_unique' => 'The forum title you entered already exists. Please choose another forum title.'));
	...
	public function create_topic($forum_slug) {
		...
		// set validation rules
		$this->form_validation->set_rules('title', 'Topic Title', 'trim|required|min_length[0]|max_length[255]|is_unique[topics.title]', array('is_unique' => 'The topic title you entered already exists in our database. Please enter another topic title.'));
		$this->form_validation->set_rules('content', 'Content', 'required|min_length[0]');
