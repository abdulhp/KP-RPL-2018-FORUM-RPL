			...
			<div class="col-md-12">
				<?= form_open() ?>
					...
					<div class="form-group">
						...
						<textarea rows="6" class="form-control ckeditor" id="description" name="description" placeholder="Enter short description for the new forum" value="<?=$description ?>"></textarea>
					</div>
					<div class="form-group">
